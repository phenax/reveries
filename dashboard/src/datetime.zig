...
pub fn parseIsoDatetime(str: []const u8, timezone: ?dt.datetime.Timezone) error{ InvalidDate, InvalidTime }!dt.datetime.Datetime {
    ...
    return dt.datetime.Datetime.create(year, month, day, hour, minute, second, 0, timezone);
}
...
pub fn formatISO8601Basic(alloc: std.mem.Allocator, datetime: dt.datetime.Datetime) ![]const u8 {
